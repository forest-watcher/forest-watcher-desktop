...
describe("Checkbox Dialog", () => {
  it("can render", () => {
    ...
    act(() => {
      ReactDOM.render(
        <Checkbox id="test" defaultChecked={true} label={"test label"} labelId="1" disabled={true} callback={mock} />,
        container
      );
    });
  ...
  it("should render a disabled input", () => {
    ...
    act(() => {
      ReactDOM.render(
        <Checkbox id="test" label={"test label"} labelId="1" disabled={true} checked={true} callback={mock} />,
        container
      );
    });
  ...
  it("should render an input that is not disabled", () => {
    ...
    act(() => {
      ReactDOM.render(
        <Checkbox id="test" label={"test label"} labelId="1" disabled={true} defaultChecked={true} callback={mock} />,
        container
      );
    });
    const enabledCheckbox = container.querySelector(".test-checkbox-enabled");
