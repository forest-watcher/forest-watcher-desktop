...
describe ('ShapefileInfo Dialog', () => {
  it('can render', () => {
    act(() => {
      ReactDOM.render(<ShapefileInfo title="Upload A Custom Data Set" maxSize="max size requirements" formats="The file must be one of the following:" unzippedTitle="Unzipped:" unzipped=".csv, .json, .geojson, .kml, .kmz" zippedTitle="Zipped:" zipped=".shp" />, container);
    });
