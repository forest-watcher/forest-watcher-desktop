...
describe ('Walkthough Dialog', () => {
  ...
  it('calls the onAccept function', () => {
    const mock = jest.fn()
    act(() => {
      ReactDOM.render(<Walkthough onAccept={mock} title="title text" intro="intro text" steps={[{"content":"Content 1."},{"content":"Content 2"},{"content":"Content 3","childContent":"Child content"},{"content":"Content 4"}]} />, container);
    });
