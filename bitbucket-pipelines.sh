...
echo "REACT_APP_API_AUTH=$REACT_APP_API_AUTH" >> .env
echo "REACT_APP_API_AUTH_CALLBACK_URL=$REACT_APP_API_AUTH_CALLBACK_URL" >> .env
...
echo "REACT_APP_GOOGLE_PLUS_ONE_WIDGET_API=$REACT_APP_GOOGLE_PLUS_ONE_WIDGET_API" >> .env
