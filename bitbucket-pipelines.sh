...
echo "REACT_APP_API_URL_V1=$REACT_APP_API_URL_V1" >> .env
echo "REACT_APP_API_AUTH_URL=$REACT_APP_API_AUTH_URL" >> .env
echo "REACT_APP_API_URL_V3=$REACT_APP_API_URL_V3" >> .env
...
if [ $1 = "test" ]
then
  echo "REACT_APP_API_URL_V1=$REACT_APP_API_URL_V1_TEST" >> .env
  echo "REACT_APP_API_AUTH_URL=$REACT_APP_API_AUTH_URL_TEST" >> .env
  echo "REACT_APP_API_URL_V3=$REACT_APP_API_URL_V3_TEST" >> .env
  echo "REACT_APP_API_AUTH_CALLBACK_URL=$REACT_APP_API_AUTH_CALLBACK_URL_TEST" >> .env
fi

if [ $1 = "staging" ]
then
  echo "REACT_APP_API_URL_V1=$REACT_APP_API_URL_V1_STAGING" >> .env
  echo "REACT_APP_API_AUTH_URL=$REACT_APP_API_AUTH_URL_STAGING" >> .env
  echo "REACT_APP_API_URL_V3=$REACT_APP_API_URL_V3_STAGING" >> .env
